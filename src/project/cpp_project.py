...
TEMPLATE_DIR = pth.join(pth.dirname(pth.realpath(__file__)), "cpp_templates")

class CPP_Project(object):
	"""
	...
	def create(self):
		...
		main_template = os.path.join(TEMPLATE_DIR, 'main.cpp')
		shutil.copyfile(main_template, 'src/main.cpp')
